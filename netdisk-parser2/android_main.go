...
//export Java_com_netdisk_parser2_MainActivity_StartServer
func Java_com_netdisk_parser2_MainActivity_StartServer(env *C.JNIEnv, clazz C.jobject, dir C.jstring, tz C.jint) {
